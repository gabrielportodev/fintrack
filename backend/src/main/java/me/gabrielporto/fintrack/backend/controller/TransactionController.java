...
public class TransactionController {
    ...
    @GetMapping("/month")
    public ResponseEntity<ApiResponse<List<TransactionResponse>>> findByMonth(
            @RequestParam int month, @RequestParam int year) {
        return ResponseEntity.ok(ApiResponse.success(
                transactionService.findByMonth(month, year), "Transações do mês listadas com sucesso"));
    }
    ...
    public ResponseEntity<ApiResponse<TransactionResponse>> update(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(transactionService.update(id, request), "Transação atualizada com sucesso"));
    }
    ...
    public ResponseEntity<ApiResponse<List<TransactionResponse>>> findByRange(
        ...
        return ResponseEntity.ok(ApiResponse.success(
                transactionService.findByRange(startMonth, startYear, endMonth, endYear),
                "Transações do período listadas com sucesso"));
    }
    ...
    public ResponseEntity<ApiResponse<List<MonthlySummaryResponse>>> getSummaryRange(
            ...
            @RequestParam int endYear) {
        return ResponseEntity.ok(ApiResponse.success(
                transactionService.getSummaryRange(startMonth, startYear, endMonth, endYear),
                "Resumo do período obtido com sucesso"));
    }
